...
import { StyleSheet, ScrollView, TouchableHighlight, View, Image, Text, Alert } from "react-native";
    ...
    return <TouchableHighlight
      ...
      <View style={{marginLeft:10,flexDirection:'row'}}>
        <Image source={require('./img/ic_sort.png')} resizeMode='stretch'
               style={[{opacity:1,width:16,height:16,marginRight:10,},this.props.theme.styles.tabBarSelectedIcon]}/>
